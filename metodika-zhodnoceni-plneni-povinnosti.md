...
Pokud jsme s plněním dané povinnosti ani nezačali, zvolíme hodnotu „Dosud neplní“, a to bez ohledu na příčinu tohoto stavu. Ať už jde o aktuální technickou nepřipravenost nebo o důvody zapříčiněnými kupříkladu jiným orgánem veřejné moci, z našeho pohledu jde vždy o neplnění povinnosti a varovný signál. Hodnota „Dosud neplní“ nevysvětluje míru našeho zavinění a nerozlišuje příčiny neplnění povinnosti, konstatuje pouze stav, který musíme pomocí nápravných opatření urychleně řešit.

✴️ POZOR: Nelze vyloučit tendenci některých úřadů ke zkreslování reálného stavu plnění povinností, aby tím skryly neplnění některých zákonem stanovených závazných povinnosti či nepřipravenost. Ve vlastním zájmu by se takovému chování měly úřady vyvarovat, hlavní motivací a potřebou je znalost reálného stavu plnění povinností a znalost cesty k dosažení souladu s kompletním plněním povinností. Z tohoto pohledu je důležité se na věc nedívat jako na „sebeudání“. Je třeba si uvědomit, že v naprosté většině případů není dlouhodobě a systémově neplnění dané povinnosti řešeno, úřad se tedy nemůže vymlouvat na skutečnost, že neplnění povinnosti odhalil teprve nyní na základě zpracování Assessmentu EG povinností.
